...
def fixed_text_data(mbti_info, mbti_type_qualities, page_10_content):
    fixed_text_const = {
        1: {
            5: """תרגום החוברת מבוצע בין השאר (אך לא רק) על ידי מערכות בינה מלאכותית (AI), ולכן התרגום עלול להיות לא מדויק.\n
...
השימוש בתרגום לצרכים אישיים בלבד ועל אחריות הקורא.
        ...
        2: {
            1: """דוח הפרשנות שלך הוא תיאור מעמיק ומותאם אישית של העדפות האישיות שלך, הנגזרות מתשובותיך בשאלון שמילאת.
...
4.	להבין שאחרים כנראה לא מנסים להרגיז אותך כשהם משתמשים בסגנונות התקשורת שלהם."""
        ...
        10: {
            1: """__**יישום תוצאות שלב II™ לקבלת החלטות**__
...
אם חסרה לכם פרספקטיבה, עשו מאמצים נוספים לשקול מה זה עשוי להוסיף.""",
        ...
        11: {
            3: """נראה ששינוי הוא בלתי נמנע ומשפיע על אנשים בדרכים שונות. כדי לעזור לך להתמודד עם שינוי:
...
טיפוס האישיות שלך משפיע גם על סגנון ניהול השינויים שלך, במיוחד התוצאות שלך בתשעת ה׳פנים׳ שלהלן. סקור את הפנים והטיפים לשיפור התגובה שלך לשינוי."""
        ...
        12: {
            3: """קונפליקטים הם בלתי נמנעים בעבודה עם אחרים. אנשים עם טיפוסי אישיות מובהקים עשויים להיות שונים במה שהם מגדירים כקונפליקט, כיצד הם מגיבים אליו וכיצד הם מגיעים לפתרון. למרות שלפעמים הם לא נעימים, קונפליקטים מובילים לעתים קרובות למצבי עבודה משופרים וליחסים משופרים.
