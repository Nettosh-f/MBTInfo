...
def insert_fixed_text(input_file, output_file, page_line_text_map):
    try:
        ...
        for line in lines:
            ...
            if (
                current_page in page_line_text_map
                and line_count_in_page in page_line_text_map[current_page]
            ):
...
if __name__ == "__main__":
    ...
    from utils import extract_mbti_qualities_scores, format_mbti_string, get_all_info
